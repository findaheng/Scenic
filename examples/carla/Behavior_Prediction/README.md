...
Inspiration for these scenarios was drawn from multiple sources, including [NHSTA's 37 common pre-crash scenarios](https://rosap.ntl.bts.gov/view/dot/41932/dot_41932_DS1.pdf) and the INTERACTION dataset](https://github.com/interaction-dataset/interaction-dataset).
