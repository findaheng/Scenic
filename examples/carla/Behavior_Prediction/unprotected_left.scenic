...
egoManeuver = filter(lambda m: m.type == ManeuverType.STRAIGHT, egoStartLane.maneuvers)
...
advManeuver = filter(lambda m: m.type == ManeuverType.LEFT_TURN and m.startLane.road is egoStartLane.road, egoStartLane.maneuvers)
